...
})(["font-size:3rem;font-weight:600;margin-left:2rem;position:relative;a{padding:0.5rem 1rem;color:black;text-decoration:none;}@media (max-width:1000px){margin:0;text-align:center;}"]);
